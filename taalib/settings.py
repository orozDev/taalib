"""
Django settings for taalib project.
...
SECRET_KEY = 'django-insecure-si_z6fxmv-evcn()m(ruuk2teb0swt+=x2&-@rq)kc$+ofja2v'
...
WSGI_APPLICATION = 'taalib.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": _("Открыть сайт"), "url": "/", "new_window": False},
    ...
    "icons": {
        'core.Articles': 'fas fa-newspaper',
        'core.Videos': 'fab fa-youtube',
        'core.Categories': 'fas fa-tags',
